...
class ChronoAmperometryWithLimits:
    ...
    def make_calim_params(self):
        ...
        p_current_steps.append(make_ecc_parm(self.device, calim_param_names["test1_config"], self.limit_variable, idx))
        p_current_steps.append(make_ecc_parm(self.device, calim_param_names["test1_value"], self.limit_values, idx))
